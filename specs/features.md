...
| optional count-in 4 clicks for grooves — *specced as [V9](9-count-in/)*                | One bar of claves before a groove, so a standing start has a stated tempo | Off by default. Only ever wraps a groove, never the click; the groove's own timeline still starts at step 0 |
